...
no_working_days_in_year_onsite = {}
for key in year_dict.keys():
    no_working_days_in_year_onsite.update({key: []})

for month_no in no_working_days_in_year_onsite.keys():
    for week_index in range(len(year_dict[month_no])):
        ...
        no_working_days_in_year_onsite[month_no].append(working_days)
        
print("no_working_days_in_year_onsite",no_working_days_in_year_onsite)
        
for month_no in no_working_days_in_year_onsite:
    list_wking_days_in_weeks_onsite = no_working_days_in_year_onsite[month_no]
    for week_column in range(0, len(list_wking_days_in_weeks_onsite)):
        Sheet1.cell(row=2 + month_no, column=week_column + 11).value = list_wking_days_in_weeks_onsite[week_column]
...
for month_no in no_working_days_in_year:
    list_wking_days_in_weeks = no_working_days_in_year[month_no]
    for week_column in range(0, len(list_wking_days_in_weeks)):
        Sheet1.cell(row=2 + month_no, column=week_column + 3).value = list_wking_days_in_weeks[week_column]
